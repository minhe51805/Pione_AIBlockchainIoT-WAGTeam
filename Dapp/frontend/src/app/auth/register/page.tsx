...
export default function RegisterPage() {
  ...
  const handlePasskeyRegister = async () => {
    ...
    try {
      ...
      console.log('🔐 Starting Passkey registration for:', formData.full_name);
      ...
      if (!passkeyResult.success) {
        console.error('❌ Passkey registration failed:', passkeyResult.error);
        throw new Error(passkeyResult.error || 'Đăng ký vân tay thất bại');
      }

      console.log('✅ Passkey credential received:', passkeyResult.credentialId);
      ...
      if (!apiResult.success) {
        console.error('❌ Backend registration failed:', apiResult.error);
        throw new Error(apiResult.error || 'Đăng ký thất bại');
      }

      console.log('✅ User registered in database:', apiResult.user_id);
      console.log('💰 Wallet address:', apiResult.wallet_address);
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <Button
              ...
              disabled={loading}
              className={`w-full ${authMethod === 'passkey'
